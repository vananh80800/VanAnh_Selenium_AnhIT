...
public class Demo_alert_OK {
    public static void main(String[] args) throws InterruptedException {
        ...
        // Lấy text hiển thị trên UI
        String actualText = driver.findElement(By.id("result")).getText();
        String expectedText = "You clicked an alert successfully";

        Assert.assertEquals(actualText, expectedText);


        System.out.println("ASSERT PASSED: Text hiển thị đúng sau khi nhấn OK");
